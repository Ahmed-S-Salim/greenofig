-- =====================================================
-- COMPREHENSIVE NUTRITIONIST PLATFORM FEATURES (FIXED)
-- Date: 2025-11-22
-- Implements:
...
-- Messages table - Drop and recreate to ensure thread_id exists
...
-- Messages - Now safe to create since we dropped and recreated the table
