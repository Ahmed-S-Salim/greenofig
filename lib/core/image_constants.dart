class ImageConstant {
  ...
  static const String placeholderImage =
      'https://via.placeholder.com/300x200/f0f0f0/cccccc?text=Image';
  static const String profilePlaceholder =
      'https://via.placeholder.com/100x100/e8e8e8/999999?text=Profile';

  // Common error and loading states
  static const String errorPlaceholder =
      'https://via.placeholder.com/300x200/ffebee/f44336?text=Error';
  static const String loadingPlaceholder =
      'https://via.placeholder.com/300x200/e3f2fd/2196f3?text=Loading';
}
