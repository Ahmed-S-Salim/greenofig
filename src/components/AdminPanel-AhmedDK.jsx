...
import { Database, TrendingUp, Users, CreditCard, ShieldQuestion, FileText, Globe, Ticket, Gift, DollarSign, LayoutDashboard, BarChart3, ArrowLeft, Wallet, Bot, UserCog, Bug, MessageSquare, Sparkles, Calendar, LineChart } from 'lucide-react';
...
const AdminPanel = ({ user }) => {
  ...
  const allTabs = [
    ...
    { id: 'google-analytics', label: 'Website Analytics', icon: LineChart },
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case 'errors':
        return <ErrorMonitorPanel user={user} />;
      case 'studio':
      ...
      case 'messaging':
        return <MessagingSettings user={user} />;
      case 'blog':
  ...
  return (
    <div className="max-w-7xl xl:max-w-[1600px] 2xl:max-w-[1800px] mx-auto px-4 lg:px-6 xl:px-8">
      {/* Content */}
      <ErrorBoundary>
        <motion.div
          key={activeTab}
